...
<body>
    ...
    $game->team_b_abb }})</button>
        ...
        <div class="d-flex justify-content-center mt-3">
            <!-- Team A Score Button with Modal Trigger -->
            <button class="btn btn-primary mr-3" data-toggle="modal" data-target="#teamSubstitution"
                onclick="showTeamSubstitutionModal({{ $game->teamA->id }})">Team A Substitutions ({{ $game->team_a_abb
                }})</button>
            <!-- Team B Score Button with Modal Trigger -->
    ...
    <div class="modal fade" id="teamAModal" tabindex="-1" role="dialog" aria-labelledby="teamAModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST"
                    action="{{ route('admin.games.team.score', ['game' => $game, 'team' => $game->teamA]) }}">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="scoredTimeA" name="scored_time"
    ...
    <div class="modal fade" id="teamAFoulModal" tabindex="-1" role="dialog" aria-labelledby="teamAFoulModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="POST"
                    action="{{ route('admin.games.team.cardLog', ['game' => $game, 'team' => $game->teamA]) }}">
                    @csrf
                    <div class="modal-header">
    ...
    <div class="modal logModal fade" id="teamSubstitution" tabindex="-1" role="dialog"
        aria-labelledby="teamSubstitutionLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
    ...
    {{-- Modal for Score Log --}}
    <div class="modal logModal fade custom-centered-modal" id="scoreLogModal" tabindex="-1" role="document"
        aria-labelledby="scoreLogModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="padding: 5px;">
                <div id="scoreLogContent"></div>
            </div>
        </div>
    </div>

    {{-- Modal for Foul Log --}}
    <div class="modal logModal fade custom-centered-modal" id="foulLogModal" tabindex="-1" role="dialog"
        aria-labelledby="foulLogModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="padding: 5px;">
                <div id="foulLogContent"></div>
            </div>
        </div>
    </div>

    {{-- Modal for Substitution Log --}}
    <div class="modal fade custom-centered-modal" id="substitutionLogModal" tabindex="-1" role="dialog"
        aria-labelledby="substitutionLogModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="padding: 5px;">
                <div id="substitutionLogContent"></div>
            </div>
        </div>
    </div>
